...
function Navbar() {
  ...
  return (
    <div className="text-black flex justify-between mx-auto p-5 h-20  items-center bg-gradient-to-r from-blue-200 to-blue-100">
      <a href="/" className="mx-11 w-44 font-bold">
      ...
      <div
        className={
          nav
            ? "fixed left-0 top-0 w-[80%] h-screen bg-[#1b1a1a] opacity-95 p-4 ease-in-out duration-500"
            : "ease-in-out duration-500 fixed left-[-100%] top-0 w-[80%] h-full p-4"
        }
      >
        ...
        <ul className="pt-10 uppercase h-screen ">
          <a href="/About">
            <li className="py-5 px-4 text-2xl hover:text-[#A0BDFF] cursor-pointer">
              About Us
            </li>
          </a>
          <a href="/Blog">
